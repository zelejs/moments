 ...
 */
public class StockEvaluationAdditionFilter implements CRUDFilter<StockEvaluationAddition> {

    private String[] ignoreFields = new String[]{};
    private String[] updateIgnoreFields = new String[]{};

    @Override
    public void filter(StockEvaluationAddition entity, boolean insertOrUpdate) {
